package com.example.sayan.kotlinweatherapp
...
import com.example.sayan.kotlinweatherapp.Common.Common
import com.example.sayan.kotlinweatherapp.Common.Helper
import com.example.sayan.kotlinweatherapp.Model.OpenWeatherMap
...
class MainActivity : AppCompatActivity() , GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    internal val openWeatherMap =OpenWeatherMap()
